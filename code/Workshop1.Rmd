...
nrow specifies the number of rows in which the panels are arranged.
ncol specifies the number of columns. 
Scales, shrink, and labeller, as.table, switch, drop, dir, strip.position, axes, axis.labels
...
ggplot(data = mpg_summary, aes(x = displ, y = hwy, fill = class)) +
